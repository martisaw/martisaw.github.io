<template>
    <i>Notice: Since this server resides in Germany, and since the author of the website is German citizen, the German law applies for the entire website. Therefore, the data protection declaration is presented in German.</i>
    ...
    <p>
        GitHub Pages bei GitHub, Inc. 88 Colin P Kelly Jr Street San Francisco, CA 94107 United States
        <br>
        Aus Sicherheitsgründen wird bei einem Besuch einer GitHub Pages die IP Adresse des Besuchenden gespeichert. F&uuml;r mehr Infos siehe <a href="https://docs.github.com/en/articles/github-privacy-statement">GitHub Privacy Statement</a>.
    </p>
    <!--<p>
        netcup GmbH
        <br />Daimlerstra&szlig;e 25
        <br />D-76185 Karlsruhe
    </p>
    ...
    <p>
        Martin Sawilla
        <br />Essenweinstra&szlig;e 51
        <br />76131 Karlsruhe
    </p>

    <p>
        <br />E-Mail: info@env42day.de
    </p>
